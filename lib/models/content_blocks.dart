...
class ContentBlock {
  ...
  /// Parses lines like `#mmea` or `#mmea Maelezo ya mmea`.
...
class RichContentBody {
  ...
  /// Converts `#mmea` paragraphs into tag blocks for storage.
  ...
  /// Parses JSON rich content or falls back to plain text paragraphs.
